...
// source-hash: 6f26e4411c15c0f92681744ff07e762afbf7689c
let wasm;
 ...
 * @returns {boolean}
 */
export function is_point_in_polygon(point, polygon) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.is_point_in_polygon(
      retptr,
      addHeapObject(point),
      addHeapObject(polygon),
    );
...
const imports = {
  __wbindgen_placeholder__: {
    ...
    __wbg_getwithrefkey_4a92a5eca60879b9: function (arg0, arg1) {
      const ret = getObject(arg0)[getObject(arg1)];
      return addHeapObject(ret);
    },
...
const loader = new WasmBuildLoader({
  imports,
  cache: isNodeOrDeno
    ? (await import("https://deno.land/x/wasmbuild@0.15.5/loader/cache.ts"))
      .cacheToLocalDir
    : undefined,
});
/**
 ...
 *   exports: { is_point_in_polygon: typeof is_point_in_polygon }
 * }>}
 */
